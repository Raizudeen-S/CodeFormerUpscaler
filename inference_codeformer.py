...
if __name__ == "__main__":
    ...
    face_helper = FaceRestoreHelper(
        args.upscale, face_size=512, crop_ratio=(1, 1), det_model=args.detection_model, save_ext="png", use_parse=True, device=device
    )
    ...
    for i, img_path in enumerate(input_img_list):
        ...
        if args.has_aligned:
            ...
            num_det_faces = face_helper.get_face_landmarks_5(only_center_face=args.only_center_face, resize=640, eye_dist_threshold=5)
